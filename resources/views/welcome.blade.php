...
<div class="d-flex justify-content-center">
   <div class="row">
      <div class="col-md-4">
         <form action="/launch_service" method="POST">
           @csrf
            <div id="login-form" class="form-container" data-form-container style="color: rgb(198, 40, 40); background: rgb(255, 205, 210);">
               <div class="row">
                  <div class="form-title">
                     <span>Enter ASIN</span>
                  </div>
               </div>
               <div class="input-container">
                  <div class="row">
                     <span class="req-input input-password invalid">
                     <input type="text" data-min-length="8" name="asin" placeholder="ASIN">
                     </span>
                  </div>
                  <div class="row submit-row">
                     <button type="submit" class="btn btn-block submit-form invalid">Submit</button>
                  </div>
